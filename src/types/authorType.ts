export interface AuthorSearchType {
  numFound: number;
  start: number;
...
export enum AuthorAlternativeName {
  ChristopherReuelTolkien = "Christopher Reuel Tolkien",
  ChristopherTolkien = "Christopher Tolkien",
  DzhonRRTolkin = "Dzhon R. R. Tolkin",
  JRRTolkien = "J. R. R. Tolkien",
  JohnRRTolkien = "John R. R. Tolkien",
  JohnRonaldReuelTolkien = "John Ronald Reuel Tolkien",
  PaulineBaynesColorIllus = "Pauline Baynes Color Illus",
  Tolkien = "Tolkien",
  YueHanLuoNaDeRuiErTuoErJin = "Yue Han Luo Na De Rui Er Tuo Er Jin",
}
